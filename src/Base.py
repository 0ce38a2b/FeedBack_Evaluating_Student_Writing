...
def feedbackBase(args):
    ...
    if args.da:
        df_da = pd.read_csv("/users10/lyzhang/opt/tiger/feedback/data/train_da_fold_0.csv")
        if args.debug:
...
def predict(args):
    args.device = torch.device('cuda') if torch.cuda.is_available() else torch.device('cpu')
    model_list = [
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_27_12_46/Fold_0.bin", "/users10/lyzhang/model/funnel_large"),    # 0.6742
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_09_22_58/Fold_0.bin", "/users10/lyzhang/model/deberta_xlarge"), # 0.7092
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_28_14_00/Fold_0.bin", "/users10/lyzhang/model/funnel_large"),    # 0.6794
        # # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_27_13_49/Fold_0.bin", "/users10/lyzhang/model/deberta_v3_large")
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_28_22_27/Fold_0.bin", "/users10/lyzhang/model/deberta_v3_large"), # 0.6842
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_04_18_39/Fold_0.bin", "/users10/lyzhang/model/bigbird_roberta_large"), # 0.6549
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_05_00_00/Fold_0.bin", "/users10/lyzhang/model/deberta_large"), # 0.7012
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_03_21_33/Fold_0.bin", "/users10/lyzhang/model/longformer_large_4096"), # 0.6748
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_28_22_30/Fold_1.bin", "/users10/lyzhang/model/funnel_large"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_01_18_57/Fold_1.bin", "/users10/lyzhang/model/deberta_v3_large"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_10_23_46/Fold_2.bin", "/users10/lyzhang/model/deberta_xlarge"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_07_23_08/Fold_2.bin", "/users10/lyzhang/model/deberta_large"),

        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_09_22_12/Fold_3.bin", "/users10/lyzhang/model/funnel_large"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_09_22_11/Fold_3.bin", "/users10/lyzhang/model/longformer_large_4096"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_07_12_35/Fold_3.bin", "/users10/lyzhang/model/deberta_xlarge"),
        
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_09_20_48/Fold_5.bin", "/users10/lyzhang/model/longformer_large_4096"),
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_08_22_12/Fold_5.bin", "/users10/lyzhang/model/deberta_v3_large"),
        
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_08_05_58/Fold_6.bin", "/users10/lyzhang/model/deberta_large"),


    ]
    model_list = [
        # ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_02_27_12_46/Fold_0.bin", "/users10/lyzhang/model/funnel_large"),    # 0.6742
        ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_11_14_54/Fold_4.bin", "/users10/lyzhang/model/deberta_xlarge"),
        ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_11_14_53/Fold_3.bin", "/users10/lyzhang/model/deberta_xlarge"),
        ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_11_14_52/Fold_2.bin", "/users10/lyzhang/model/deberta_xlarge"),
        ("/users10/lyzhang/opt/tiger/feedback/model/LF/2022_03_11_14_48/Fold_1.bin", "/users10/lyzhang/model/deberta_xlarge"),
    ]
    ...
    for model in model_list:
        ...
        np.save("/users10/lyzhang/opt/tiger/feedback/output_5fold/{}_fold{}.npy".format(model[0].split(".")[0][-1], model[1].split("/")[-1]), pred)
        results.append({
            "probability": pred,
    ...
    submit_df.to_csv("/users10/lyzhang/opt/tiger/feedback/output/submit.csv", index=False)
    submit_df = Utils.do_threshold(submit_df, use=['length', 'probability'])
    # submit_df = Utils.do_threshold(submit_df, use=['length'])
    submit_df.to_csv("/users10/lyzhang/opt/tiger/feedback/output/submit_drop.csv", index=False)
