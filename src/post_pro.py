...
def test():
    args = Config()
    model_list = [
        ("/users10/lyzhang/chye/output/funnel_large.npy", "/users10/lyzhang/model/funnel_large"),    # 0.6794
        ("/users10/lyzhang/chye/output/deberta_v3_large.npy", "/users10/lyzhang/model/deberta_v3_large"), # 0.6842
        ("/users10/lyzhang/chye/output/bigbird_roberta_large.npy", "/users10/lyzhang/model/bigbird_roberta_large"), # 0.6549
        ("/users10/lyzhang/chye/output/deberta_large.npy", "/users10/lyzhang/model/deberta_large"), # 0.7012
        ("/users10/lyzhang/chye/output/longformer_large_4096.npy", "/users10/lyzhang/model/longformer_large_4096"), # 0.6748
    ]
