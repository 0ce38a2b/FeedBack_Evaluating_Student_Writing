...
test_list = [
    ([
        ("/users10/hsheng/opt/tiger/feedback/output_5fold/4_folddeberta_xlarge.npy", "/users10/hsheng/model/deberta_xlarge"),
    ], "/users10/hsheng/opt/tiger/feedback/data/train_fold5.csv", 4),
    ([
        ("/users10/hsheng/opt/tiger/feedback/output_5fold/3_folddeberta_xlarge.npy", "/users10/hsheng/model/deberta_xlarge"),
    ], "/users10/hsheng/opt/tiger/feedback/data/train_fold5.csv", 3),
    ([
        ("/users10/hsheng/opt/tiger/feedback/output_5fold/2_folddeberta_xlarge.npy", "/users10/hsheng/model/deberta_xlarge"),
    ], "/users10/hsheng/opt/tiger/feedback/data/train_fold5.csv", 2),
    ([
        ("/users10/hsheng/opt/tiger/feedback/output_5fold/1_folddeberta_xlarge.npy", "/users10/hsheng/model/deberta_xlarge"),
    ], "/users10/hsheng/opt/tiger/feedback/data/train_fold5.csv", 1),
]
results_list = []
df_text_list = []
